...
Contributors: bingwebmastertools, jaroslavhlavinka
Plugin link: https://github.com/neologyc/IndexNowForSearchSeznamCZ
Tags: seo, crawling, indexnow, seznam, seznambot, seznamcz
...
Tento plugin vznikl jako tzv. fork (vychází z kódu jiného pluginu) z [pluginu IndexNow od týmu Bing Webmaster](https://wordpress.org/plugins/indexnow/)` v rámci GPLv2.
...
* Jdi do stránky s nastavením 'Nástroje > IndexNow' a klikni na 'Let's Get Started!'
